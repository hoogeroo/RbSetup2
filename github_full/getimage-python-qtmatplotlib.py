...
from PyQt5 import QtCore, QtGui, QtWidgets, Qcustomplot
...
class Picture(FigureCanvas):
    def __init__(self,xs,ys,parent=None, width=512, height=512, dpi=500):
        ...
        self.figure =  Figure(figsize=(width, height), dpi=dpi) #QtGui.QImage(512,512,QtGui.QImage.Format_RGB32)
