...
AFG_TCP="130.216.50.16"

class TekAFG(QWidget):
  def __init__(self):
      super().__init__()
      ...
      self.layout.addWidget(self.RF_stop_label,0,0)
      self.layout.addWidget(self.RF_stop_freq,1,0)
      ...
      self.layout.addWidget(self.RF_start_label,0,1)
      self.layout.addWidget(self.RF_start_freq,1,1)
