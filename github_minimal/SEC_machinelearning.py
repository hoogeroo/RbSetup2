    ...
    def iterate(self, N = None):
        ...
        for _ in range(N):
            ...
            if self.niter <= self.trainingsteps:
              ...
              self.parent().MLBayesLabel = QLabel(f'Bayesian iterations: {self.niter-self.trainingsteps}; min cost = {np.min(costvec[:,0])}')
...
#|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|\|/|
    ...
    def run_expt(self, params=None): 
        ...
        time.sleep(10) # Replace with subroutine to monitor fluorescence?
