...
class allboxes(QWidget):
    ...
    def checkMLParams(self, trainingsteps = None):
      ...
      elif name_split[0][0:3] == '202': #Basically, if it starts with a time in the year 2023 we assume we've tacked the date onto the start (meaning it's a prior ML run)
