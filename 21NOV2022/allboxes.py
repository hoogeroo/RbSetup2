...
class allboxes(QWidget):
    ...
    def saveOptData(self,foldstring):
         filename=f'{foldstring}/Data_{str(i)}.fit'
    ...
    # TO DO
        ...
        self.optimiser.load()
        mgo_index = self.MGPanel.cbExpKind.findText(self.optimiser.mydate)
        self.MGPanel.cbExpKind.setCurrentIndex(mgo_index)
