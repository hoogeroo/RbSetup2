...
#      self.layout.addWidget(self.plotSet,0,2+maxcol,len(stge.DC)+3,1)
    ...
    def loadData(self):
            ...
            for tid in range(len(stages)):
                ...
                for row in range(len(self.devicenames['DAC'])):
                    ...
                    """                    if box_val > -10:
                        ...
                        """
                    if ((box_val>=0.0) and (box_val<=5.0)):
                ...
                box_list.append(box_vals)
                #not needed, expand to see, or delete comment marks to get working
                """
        ...
        #not needed so commented and hidden, includes stuf for time_aom.
        """    
            ...
            if (len(msg2)>6) and self.allAOMS:
                ...
                self.nsamples=timestepstilnow"""
        print("gap")
        #print(box_list,'box_val_list and length >',len(box_list))
        #print("box len",#len(box_val_array))
        #print("ones_list",ones_list)
        ones_list_length = []
        for i in range(len(ones_list)):
            ones_list_length.append(ones_list[i])
        for i in range(len(ones_list)):
            ones_list_length.append(ones_list[i])
        print(len(ones_list_length))
