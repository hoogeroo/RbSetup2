...
class Fastino_Multi_Output(EnvExperiment):
    ...
    def prepare(self):
        ...
        self.data_1 = self.voltage_arrays
    @kernel
    def record(self):
        with self.core_dma.record("test"):
            ...
            #print(voltages)
            self.fastino0.set_group(0, [2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2])
            delay(50 * ms)    
            self.fastino0.set_group(0, [1,1,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2])
            delay(50 * ms)
            #delay(timestep * ms)
    @kernel
    def run(self):
