...
#==============================================================================================================
    ...
    #\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/          
        ...
        prihdr['BF_CEN_0'] = (self.bfcam.center[0], 'Blackfly Figure Center row')
        prihdr['BF_DIM_0'] = (self.bfcam.dims[0], 'Blackfly Figure Dimensions row')
        prihdr['BF_CEN_1'] = (self.bfcam.center[1], 'Blackfly Figure Center column')
        prihdr['BF_DIM_1'] = (self.bfcam.dims[1], 'Blackfly Figure Dimensions column')
